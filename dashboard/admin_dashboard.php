...
<body>
  ...
  <!-- Top Navbar -->
  <div class="mx-md-7 bg-base w-100">
    <div class="h-14 bg-base mt d-flex justify-content-end align-items-center mx-3 mt-2">
        <!-- Search Bar -->
        <div class="d-none d-sm-flex position-relative me-3">
            <input
                class="form-control py-1 ps-5 pe-3 border border-dark rounded-pill"
                type="search"
                placeholder="Search"
                id="searchInput"
            />
        ...
        <!-- User Info -->
        <div class="me-5">
            <h5 class="fw-semibold mb-0"><?php echo htmlspecialchars($user['first_name']) . ' ' . htmlspecialchars($user['last_name']); ?></h5>
...
<div class="container-fluid mt-4">
    ...
    <div class="d-md-flex justify-content-evenly">
        ...
        <div class="h-100 p-1 w-50">
            ...
            <div class="organization-card p-4 bg-white rounded shadow-sm d-flex align-items-center mt-4 mb-6 border">
                <img class="organization-logo me-3" src="byte.png" alt="Byte Logo" />
                <div class="organization-details">
                    <p class="text-secondary font-normal small-text">Name of Student Organization</p>
                    <h1 class="fw-semibold h5 mb-3">Beacon of Youth Technology Enthusiasts</h1>
                    <div class="d-flex gap-4">
                        <div>
                            <p class="text-secondary font-normal small-text">No. of Members</p>
                            <h1 class="fw-semibold h6">557</h1>
                        </div>
                        <div>
                            <p class="text-secondary font-normal small-text">Status</p>
