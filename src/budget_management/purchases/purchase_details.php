        ...
        <div class="body-wrapper">
            ...
            <div class="container mt-5 p-4">
                ...
                <div class="tab-pane fade show active" id="financial-plan" role="tabpanel" aria-labelledby="financial-plan-tab">
                    ...
                    <h4>Items<?php if ($purchase['completion_status'] === 0): ?>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th>Amount</th>
                                <th>Total Amount</th>
                                <?php if ($purchase['completion_status'] === 0): ?>
                                    <th>Actions</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
                            ...
                            if (!empty($items)) {
                                foreach ($items as $item) {
                                    ...
                                    echo "<tr>
                                            ...
                                            <td>{$item['amount']}</td>
                                            <td>{$total_amount}</td>";
                                    if ($purchase['completion_status'] === 0) {
                                        echo "<td>
                        ...
                        <div class="modal-content">
                            ...
                            <form id="editItemForm">
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" id="edit_event_id" name="purchase_id"
                                        value="<?php echo $purchase_id; ?>"> <!-- Add purchase_id -->
                                    <div class="form-group row mb-2">
                                        <div class="col">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <!-- Hidden form for item and purchase IDs -->
                                <form id="deleteItemForm">
                                    <input type="hidden" name="item_id" id="delete_item_id"> <!-- Item ID -->
                                    <input type="hidden" name="purchase_id" id="delete_event_id" value="<?php echo $purchase_id; ?>"> <!-- Purchase ID -->
                                </form>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <form id="summaryAddItemForm" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    <input type="hidden" name="purchase_id" value="<?php echo $purchase_id; ?>">
                                    <!-- Dropdown to select an purchase -->
                        ...
                        <div class="modal-content">
                            <form id="summaryEditItemForm" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" id="summary_edit_event_id" name="purchase_id"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="summaryDeleteItemForm">
                                    ...
                                    <input type="hidden" name="purchase_id" id="summary_delete_event_id" value="<?php echo $purchase_id; ?>"> <!-- Purchase ID -->
                                </form>
