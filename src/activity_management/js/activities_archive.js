...
$(document).on("click", ".recover-btn", function () {
  ...
  $("#recover_event_id").val(eventId); // Set the value of the hidden input
});
...
$("#confirmRecoverBtn").on("click", function () {
  var eventId = $("#recover_event_id").val(); // Get the item ID from the hidden input field

  // Send an AJAX request to delete the item
  $.ajax({
    url: "recover_event.php", // PHP file to handle deletion
    type: "POST",
...
$("#confirmDeleteBtn").on("click", function () {
  ...
  // Send an AJAX request to delete the item
  $.ajax({
    url: "delete_event.php", // PHP file to handle deletion
    type: "POST",
    data: { event_id: eventId },
    dataType: "json",
    success: function (response) {
